...
const App: React.FC = () => {
  ...
  const [mobileView, setMobileView] = useState<
    "HOME" | "TOOLS" | "STEPS" | "ABOUT" | "STEP_DETAIL"
  >("HOME");
                            ...
                            (() => {
                              ...
                              return (
                                <div className="space-y-6">
                                  <div
                                    className="bg-slate-900 rounded-xl overflow-hidden shadow-lg border border-slate-800 text-right w-full"
                                    dir="rtl"
                                  >
                ...
                <div className="max-w-4xl mx-auto w-full px-6 py-6 space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500">
                      כלים מתקדמים לניתוח, ויזואליזציה והעמקה{" "}
                    </p>
                  </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-[11px] text-slate-500 line-clamp-2">
                            מיפוי חזותי של ישויות וקשרים סמנטיים
                          </p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-[11px] text-slate-500 line-clamp-2">
                            ניתוח תכונות קשרים וערכים מתמונות
                          </p>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-[11px] text-slate-500 line-clamp-2">
                            פרוטוקול לניתוח רוחבי של אוסף הערכות
                          </p>
                        </div>
                      </button>
                    </div>
                    ...
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          שלב הכנה: הגדרת תפקיד ומתודולוגיה
                        </p>
                      </div>
                    </div>
                    <p className="text-sm text-slate-600 mb-3">
                      הזן את המטרה שלך (למשל: "אני רוצה לנתח את הערכים
                      החברתיים"), והיועץ יבנה עבורך הנחייה מותאמת למודל השפה
                      (Prompt) המותאמת.
                    </p>
                    <div className="relative">
                      <textarea
                        ...
                        placeholder="תאר את המטרה או השאלה שלך..."
                        value={consultationInput}
                ...
                <div className="max-w-xl mx-auto w-full px-6 py-2 md:py-3 space-y-6">
                  <div className="text-right pt-2 md:pt-3">
                    <h3 className="text-lg sm:text-l font-black text-slate-500 mb-0.5 leading-tight truncate">
                      משאבים לסדנת איקומוס - אתר.בוט
                    </h3>
                  </div>
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 gap-4">
 <ResourceGroup title="קישורים לאתר.בוט">
